...
import { requireAuth, ipLimiter, accountLimiter } from './middleware/middleware.js'
...
apiRouter.post('/analyze', requireAuth, ipLimiter, accountLimiter, upload.single('resume'), getUserInfo)
